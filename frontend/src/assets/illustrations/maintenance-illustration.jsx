...
function MaintenanceIllustration({ ...other }) {
  ...
  const SURFACE_LIGHT = isDark ? "#27272a" : "#F4F6F8";
  ...
  return (
    ...
    >
      ...
      <g fill="text.disabled" opacity="0.16">
...
const MemoizedMaintenanceIllustration = memo(MaintenanceIllustration);
export default MemoizedMaintenanceIllustration;
