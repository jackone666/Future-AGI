...
function MotivationIllustration({ ...other }) {
  ...
  const GRAY_MED = isDark ? "#3f3f46" : "divider";
  const GRAY_LIGHT = isDark ? "#52525b" : "#C4CDD5";
...
const MemoizedMotivationIllustration = memo(MotivationIllustration);
export default MemoizedMotivationIllustration;
