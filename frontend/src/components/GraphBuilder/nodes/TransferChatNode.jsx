...
const TransferChatNode = ({ id, data, isConnectable }) => {
  ...
  const uniqueClassName = `transfer-chat-node-${id}`;
...
TransferChatNode.propTypes = {
  id: PropTypes.string,
  data: PropTypes.object,
  isConnectable: PropTypes.bool,
};

export default memo(TransferChatNode);
