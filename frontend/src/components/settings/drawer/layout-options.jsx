    ...
    return (
      <Stack
        ...
        sx={{
          ...
          width: 28,
          height: 1,
          borderRight: `solid 1px ${alpha(theme.palette.text.disabled, 0.08)}`,
          ...(option === "mini" && {
            width: 16,
          }),
          ...(option === "horizontal" && {
            ...
            alignItems: "center",
            borderRight: "unset",
            borderBottom: `solid 1px ${alpha(theme.palette.text.disabled, 0.08)}`,
          }),
        }}
      >
        {circle}
        ...
        return (
          <ButtonBase
            ...
            sx={{
              ...
              height: 56,
              borderRadius: 1,
              border: `solid 1px ${alpha(theme.palette.text.disabled, 0.08)}`,
              ...(selected && {
